...
setTimeout(() => {
  ...
  return (
    <div ref={componentRef} className="relative">
      ...
      <div className="lg:hidden min-h-* text-white p-4 relative z-10">
...
<div
  style={{
    ...
    borderRadius: '3px',
    boxShadow: '0 0 8px 2px #ff9900, 0 0 24px 6px #ff9900',
    opacity: 0.95
  }}
/>
          </div>
      ...
      <div className="hidden lg:flex min-h-* items-center justify-center p-4 sm:p-6 md:p-8 lg:p-10 relative z-10">
