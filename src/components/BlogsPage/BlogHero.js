...
export default function HeroSection() {
  return (
    <div className="relative w-full min-h-[90vh] md:min-h-screen overflow-hidden" style={{ background: "#05334b" }}>
      ...
      <div className="relative z-10 flex flex-col items-center justify-center px-3 sm:px-4 text-center pt-16 sm:pt-20 md:pt-24 pb-10 sm:pb-12 md:pb-16" style={{ background: "#0a2a43" }}>
        <div className="max-w-4xl mx-auto">
          ...
          <div className="flex flex-col xs:flex-row gap-3 sm:gap-4 justify-center items-center px-2 sm:px-4 w-full max-w-xs sm:max-w-none sm:w-auto">
            <Link 
              href="#trending-blogs" 
              className="w-full sm:w-auto px-6 sm:px-8 py-3 sm:py-4 bg-gradient-to-r from-blue-500 to-cyan-400 text-white font-semibold rounded-full hover:from-blue-600 hover:to-cyan-500 transition-all duration-300 transform hover:scale-105 shadow-lg hover:shadow-xl border-4 border-white"
            >
              Trending Blogs
            </Link>
            <Link 
              href="#interview-question" 
              className="w-full xs:w-auto px-4 sm:px-6 md:px-8 py-2.5 sm:py-3 md:py-4 border-2 border-blue-300 text-blue-100 font-semibold rounded-full hover:bg-blue-100 hover:text-blue-900 transition-all duration-300 transform hover:scale-105 block text-center text-sm sm:text-base whitespace-nowrap"
              onClick={(e) => {
                e.preventDefault();
